...
formInscription.addEventListener('submit', (e) => {
    ...
    console.log("Valeur de emailInscription : " + emailInscription);
    console.log("Valeur de mdpInscription : " + mdpInscription);
...
deco.addEventListener('click', (e) => {
    ...
    console.log("Evenement sur bonton le bouton Se déconnecter");
...
formConnection.addEventListener('submit', (e) => {
    ...
    raison => {
        info.innerText = "Erreur de connection !";
        formConnection.classList.toggle('apparition');
    }
    )
})
