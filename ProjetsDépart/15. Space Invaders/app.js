...
function creationGrilleEtAliens() {
    ...
    console.log("========== Function creationGrilleEtAliens ==========");
    ...
    console.log("valeur de alienInvaders : " + alienInvaders);
...
function deplacerLeTireur(e) {
    ...
    console.log("========== Function deplacerLeTireur ==========");

    toutesLesDivs[tireurPosition].classList.remove('tireur');

    console.log("Valeur de e.keyCode : " + e.keyCode); 
...
function bougerLesAliens() {
    ...
    console.log("=========== Function bougerLesAliens ==========");
